...
export default function CreateArticlePage() {
  ...
  const handlePublish = () => {
    ...
    alert('Artikel berhasil dipublished!');
  };
      ...
      <header className="">
        <div className="flex justify-end">
          <div className="flex items-center gap-2">
            ...
            <Button onClick={handlePublish} className="sm:text-sm">
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="science">Ilmu Lingkungan</SelectItem>
                      ...
                      <SelectItem value="computer">Ekonomi</SelectItem>
                      <SelectItem value="computer">Bisnis</SelectItem>
                      <SelectItem value="computer">Pertanian</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
